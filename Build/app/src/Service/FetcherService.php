        ...
        foreach ($tags as $tag) {
            ...
            try {
                ...
                if ($this->autoCommit === true) {
                    ...
                    if ($fileExists) {
                        $commitLines[] = sprintf('* `%s`: Updated exception codes (%s).', $tag, $exceptionCodes['total']);
                    } else {
                        $commitLines[] = sprintf('* `%s`: Added exception codes (%s)', $tag, $exceptionCodes['total']);
                    }
                    break;
                }
                $this->output->writeln(
...
//        $commitLines[] = '';
//        $commitLines[] = '```';
//        $commitLines[] = ' Mode..........: ' . ($this->mode === FetchMode::All ? 'all releases' : 'missing releases');
//        $commitLines[] = ' Total.........: ' . $countTotal;
//        $commitLines[] = ' Added.........: ' . $countAdded;
//        $commitLines[] = ' Failed........: ' . $countFailed;
//        $commitLines[] = ' Skipped.......: ' . $countSkipped;
//        $commitLines[] = '';
//        $commitLines[] = ' Total(Before).: ' . $currentTotalErrorCodes->total();
//        $commitLines[] = ' Total(After)..: ' . $newTotalErrorCodes->total();
//        $commitLines[] = '```';
//        $commitLines[] = '';
//        $commitLines[] = 'Used command(s):';
//        $commitLines[] = '';
//        $commitLines[] = '```shell';
//        if ($this->mode === FetchMode::All) {
//            $commitLines[] = '> Build/Scripts/runTests.sh -s updateExceptionCodesAllTags'
//                . ($this->autoCommit ? ' -c' : '');
//        } else {
//            $commitLines[] = '> Build/Scripts/runTests.sh -s updateExceptionCodesMissingTags'
//                . ($this->autoCommit ? ' -c' : '');;
//        }
//        $commitLines[] = '```';
//        $commitLines[] = '';
