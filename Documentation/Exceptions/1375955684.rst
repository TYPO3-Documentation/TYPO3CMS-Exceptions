...
-  …and deleting the complete »typo3temp« folder → in this case see bug
   `51747 <https://forge.typo3.org/issues/51747>`__ [not available
   anymore], manually creating the folder »typo3temp/_processed_« seems
   to fix the problem for most people.
