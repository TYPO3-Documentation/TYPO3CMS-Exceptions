...
-  @see: https://forge.typo3.org/issues/59369 [not available anymore]

According to https://forge.typo3.org/issues/59369#note-2 [not available
anymore] the errormessage in the navigation part of the frameModule is:
