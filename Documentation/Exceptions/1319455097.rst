...
6.2.12 – contrary to https://forge.typo3.org/issues/58403#note-3 [not
available anymore] I re-created a file storage for ``/``, but without
setting it as standard (``fileadmin/`` is still the standard storage).
The problem seems to be solved and I haven't found any new ones yet.
