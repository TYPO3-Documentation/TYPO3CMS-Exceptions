...
If the above it of no help, please check, if you somewhere in the early bootstrap
...
manager is initialized before it is determine, if the request is a frontend or
