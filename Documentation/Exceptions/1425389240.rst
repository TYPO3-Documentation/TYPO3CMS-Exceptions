...
See https://forge.typo3.org/issues/66704 [not available anymore]
...
As soon as https://forge.typo3.org/issues/66704 [not available anymore]
is fixed and the corresponding version released, an update might fix the
problem.
