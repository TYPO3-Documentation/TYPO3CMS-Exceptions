...
Check the following access: A backend user with access to :guilabel:`File>Media`
must also granted to :guilabel:`User tools > Media Extra (hidden module, required
for non admin)`.
